# DFlat-tensorflow V4
 ## Note: DFlat has moved to Pytorch (<a href="https://github.com/DeanHazineh/DFlat-pytorch" target="_blank">DFlat-pytorch</a>). While the tensorflow version will remain open, long-term support, functionality improvements, and QOL updates will only be provided for the pytorch version of the software.
<div align="center">
