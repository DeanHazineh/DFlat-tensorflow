...
class multipoly_nanocylinders_10(
    multivariate_polynomial_regression_sklearn, MLP_Nanocylinders_U180_H600,
):
    def __init__(self, **kwargs):
        ...
        self.set_modelSavePath(
            "neural_optical_layer/core/baseline_regression/fitted_regression_models/multipoly_nanocylinders_10/"
        )
...
class multipoly_nanofins_6(
    multivariate_polynomial_regression_sklearn, MLP_Nanofins_U350_H600,
):
    def __init__(self, **kwargs):
        ...
        self.set_modelSavePath(
            "neural_optical_layer/core/baseline_regression/fitted_regression_models/multipoly_nanofins_6/"
        )
