...
def run_training_neural_model(
    model_caller, epochs, miniEpoch=1000, batch_size=65536, lr=1e-3, verbose=False, train=True
):
...
def run_mlp_training_nanofins(train=True, verb=False):
    ...
    # )
    # run_training_neural_model(
    #     model_caller=MLP_models.MLP_Nanofins_Dense256_U350_H600, epochs=1, miniEpoch=1, train=train, verbose=verb
    # )
    # run_training_neural_model(
    #     model_caller=MLP_models.MLP_Nanofins_Dense128_U350_H600, epochs=1, miniEpoch=1, train=train, verbose=verb
    # )
    # run_training_neural_model(
    #     mode8l_caller=MLP_models.MLP_Nanofins_Dense64_U350_H600, epochs=1, miniEpoch=1, train=train, verbose=verb
    # )
    # run_training_neural_model(
    #     model_caller=MLP_models.MLP_Nanofins_Dense32_U350_H600, epochs=1, miniEpoch=1, train=train, verbose=verb
    # )
...
def run_mlp_training_nanocylinders(train=True, verb=False):
    run_training_neural_model(
        model_caller=MLP_models.MLP_Nanocylinders_Dense256_U180_H600, epochs=1, miniEpoch=1, train=train, verbose=verb,
    )
    run_training_neural_model(
        model_caller=MLP_models.MLP_Nanocylinders_Dense128_U180_H600, epochs=1, miniEpoch=1, train=train, verbose=verb,
    )
    run_training_neural_model(
        model_caller=MLP_models.MLP_Nanocylinders_Dense64_U180_H600, epochs=1, miniEpoch=1, train=train, verbose=verb,
    )
    run_training_neural_model(
        model_caller=MLP_models.MLP_Nanocylinders_Dense32_U180_H600, epochs=1, miniEpoch=1, train=train, verbose=verb,
    )
...
if __name__ == "__main__":
    ...
    run_mlp_training_nanofins(train=True, verb=False)
