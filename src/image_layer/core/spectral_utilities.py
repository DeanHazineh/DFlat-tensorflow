...
from image_layer.core.color_space.color_space_conversion import *


def get_xyz_bar_CIE1931(channels_nm):

    xyzpath = "image_layer/core/color_space/1931XYZFunctions.txt"
...
def get_rgb_bar_CIE1931(channels_nm):
    ...
    rgbpath = "image_layer/core/color_space/1931RGBFunctions.txt"
