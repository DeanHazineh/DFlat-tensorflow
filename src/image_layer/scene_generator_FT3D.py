import image_layer.core.freiburg_imroutine as imroutine
import image_layer.core.image_gen_utilities as im_utils
import image_layer.core.spectral_utilities as spec_utils
import random
import numpy as np
...
def dataGenerator_FT_depth(
    ...
    ft_impath = "datasets_image/flyingthings3d__frames_cleanpass_webp/frames_cleanpass_webp/" + tag + "/" + set + "/"
    ft_objpath = "datasets_image/flyingthings3d__object_index/object_index/" + tag + "/" + set + "/"
    ft_matpath = "datasets_image/flyingthings3d__material_index/material_index/" + tag + "/" + set + "/"
