...
sys.path.append(".")
from cell_library_generation.core.assemble_ER import *
...
def run_nanofin_Sweep(FM=11):
    ...
    savepath = "cell_library_generation/"

    ### Run library Sweep
    ref_field, hold_field_zero_order = run_zeroOrder_library_gen(
        rcwa_parameters, paramlist, cell_fun=assemble_ER_rectangular_fin, showDebugPlot=True
    )
