...
class ERBF_Nanofins_B5000_U350_H600(MLP_Nanofins_U350_H600):
    def __init__(self, dtype=tf.float64):
        ...
        self.set_model_name("ERBF_Nanofins_B5000_U350_H600")
        self.set_modelSavePath("trained_erbf_models/ERBF_Nanofins_B5000_U350_H600/")
...
class ERBF_Nanofins_B512_U350_H600(MLP_Nanofins_U350_H600):
    def __init__(self, dtype=tf.float64):
        super(ERBF_Nanofins_B512_U350_H600, self).__init__(dtype)
