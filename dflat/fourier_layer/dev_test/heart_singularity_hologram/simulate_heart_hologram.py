...
def call_simulate_heart_singularity(engine):
    savepath = "dflat/fourier_layer/dev_test/heart_singularity_hologram/"

    ################################################
    ### Make a plot of the experimental measurements
    dataLoc = "dflat/fourier_layer/dev_test/heart_singularity_hologram/reprocessed_Daniel_experimentalData.mat"
    ...
    params_loc = "dflat/fourier_layer/dev_test/heart_singularity_hologram/metasurface_heart_parameters.pickle"
    ...
    plotPhase = phase_stack[:, 0, 0, :, :] - tf.expand_dims(tf.expand_dims(phase_stack[:, 0, 0, phase_cy_idx, phase_cx_idx], 1), 1)
    plotPhase = np.arctan2(np.sin(plotPhase), np.cos(plotPhase))
